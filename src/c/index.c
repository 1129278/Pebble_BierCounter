...
static void update_text() {
  ...
  if (s_num_drinks == 0) {
    text_layer_set_text(s_header_layer, "Pff, nüchtern...");
  } else if (s_num_drinks == 1) {
    text_layer_set_text(s_header_layer, "Bist Fahrer, hm?");
  } else if (s_num_drinks == 2) {
    text_layer_set_text(s_header_layer, "Doch kein Fahrer...");
  } else if (s_num_drinks == 3) {
    text_layer_set_text(s_header_layer, "Party started!");
  } else if (s_num_drinks == 4) {
    text_layer_set_text(s_header_layer, "Eins geht noch!");
  } else if (s_num_drinks == 5) {
    text_layer_set_text(s_header_layer, "Spiegel halten!");
  } else if (s_num_drinks == 6) {
    text_layer_set_text(s_header_layer, "Ruhig, Brauner!");
  } else if (s_num_drinks == 7) {
    text_layer_set_text(s_header_layer, "Trink Wasser!");
  } else if (s_num_drinks == 8) {
    text_layer_set_text(s_header_layer, "Hol' nen Kübel.");
  } else if (s_num_drinks == 9) {
    text_layer_set_text(s_header_layer, "Wer hält die Haare?");
  } else {
    text_layer_set_text(s_header_layer, "Ruf die Rettung!");
  }
  
  if (s_num_drinks == 1) {
    snprintf(s_body_text, sizeof(s_body_text), "%u Bier", s_num_drinks);
  } else {
    snprintf(s_body_text, sizeof(s_body_text), "%u Biere", s_num_drinks);
  }
...
static void main_window_load(Window *window) {
  ...
  text_layer_set_text(s_header_layer, "LALA");
  ...
  text_layer_set_text(s_label_layer, "intus");
